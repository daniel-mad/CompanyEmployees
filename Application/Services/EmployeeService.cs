...
public class EmployeeService : IEmployeeService
{
    ...
    {
        await CheckIfCompanyExists(companyId, trackChanges);
        var employeeInDb = await GetEmployeeForCompanyAndCheckIfExists(companyId, id, trackChanges);

        _repository.Employee.DeleteEmployee(employeeInDb);
        await _repository.SaveAsync();
    }
    ...
    public async Task<(EmployeeForUpdateDto employeeToPatch, Employee employeeEntity)> GetEmployeeForPatchAsync(Guid companyId, Guid id, bool compTrackChanges, bool empTrackChanges)
    {
        ...
        var employeeInDb = await GetEmployeeForCompanyAndCheckIfExists(companyId, id, empTrackChanges);
        var employeeToPatch = _mapper.Map<EmployeeForUpdateDto>(employeeInDb);
        return (employeeToPatch, employeeInDb);
    }
    ...
    private async Task<Employee> GetEmployeeForCompanyAndCheckIfExists(Guid companyId, Guid id, bool empTrackChanges)
    {
